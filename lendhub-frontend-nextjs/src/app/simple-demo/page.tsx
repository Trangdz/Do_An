...
import { TransactionCardSimple } from '../../components/TransactionCardSimple';
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-6">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Simple Transaction Demo</h1>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Demo transaction history with clean, simple design
                {' • '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="text-sm text-gray-500">WETH Lend</div>
              <div className="text-2xl font-bold text-purple-600">1.5</div>
            </div>
            <div className="bg-white p-4 rounded-lg border border-gray-200">
