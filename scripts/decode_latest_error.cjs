...
async function main() {
    console.log("🔍 Analyzing Latest Repay Error");
    console.log("=" .repeat(50));
    
    // Latest transaction data from error
    const txData = "0x5ceae9c4000000000000000000000000fc6a1358b663e41d2332e4496243f38fa043b0560000000000000000000000000000000000000000000000000000057239ef89c2000000000000000000000000d3cadfdfcba5d1a98e5cb0f531165375b2ea5e6c";
    ...
    // This looks like ~100 USDC - much more reasonable!
