...
async function main() {
    ...
    console.log("Testing withdraw with new user, deployer:", deployer.address);
    
    // New user address (from deploy output)
    const userAddress = "0x43D8eDbF8A2206B310F7DaE7268f50877806652d";
