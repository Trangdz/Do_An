...
async function main() {
    console.log("🧪 Testing Repay All with actual debt");
    ...
    console.log("\n📊 STEP 1: Setup - Supply WETH as collateral");
    ...
    try {
        ...
        if (userReserve.borrow.principal === 0n) {
            console.log("❌ No debt to repay, test cannot continue");
            return;
        }
    ...
    console.log("\n🎉 Repay All test completed!");
    console.log("\n💡 Key Benefits of Repay All approach:");
    console.log("✅ No need to calculate exact debt amount");
    console.log("✅ Contract automatically caps to actual debt");
    console.log("✅ No rounding errors or precision issues");
    console.log("✅ Simple and reliable implementation");
}
